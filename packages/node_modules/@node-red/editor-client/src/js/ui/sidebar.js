...
RED.sidebar = (function() {
    ...
    function showSidebar(id, skipShowSidebar) {
        if (id === ":first") {
            id = lastSessionSelectedTab || RED.settings.get("editor.sidebar.order",[ "debug", "info", "help", "version-control"])[0]
        }
        if (id) {
    ...
    function init () {
        ...
        sidebar_tabs = RED.tabs.create({
            ...
            order: RED.settings.get("editor.sidebar.order",[ "debug", "help", "version-control", "info"])
            // scrollable: true
        });
