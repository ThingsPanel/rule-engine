...
$deploy-button-background-disabled: #325C80;
$deploy-button-background-disabled-hover: #487ba9;


$header-background: #29387d;
$header-button-background-active: #325C80;
$header-menu-color: #C7C7C7;
$header-menu-color-disabled: #666;
$header-menu-heading-color: #fff;
$header-menu-sublabel-color: #aeaeae;
$header-menu-background: #325C80;
