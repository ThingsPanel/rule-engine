 ...
 * cxs
 */
else if (fs.existsSync(path.join(path.resolve(), "packages", "node_modules", "node-red", "settings.js"))) {
    settingsFile = path.join(path.resolve(), "packages", "node_modules", "node-red", "settings.js");
}
 ...
 * @type {string}
 */
let bannerFile = path.join(path.resolve(), "banner.txt");
if (fs.existsSync(bannerFile)) {
    fs.readFile(bannerFile, function (err, data) {
        if (err) {
